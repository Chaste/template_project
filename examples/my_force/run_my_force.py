...
# A templated class is wrapped once per dimension, so MyForce<2> is exposed as MyForce2.
# If this name is wrong for your build, run:
#     print([n for n in dir(myproject) if "MyForce" in n])
MyForce2 = myproject.MyForce2
